 ...
 */
 ...
 http.createServer(function (request, response) {
    response.writeHead(200, {'Content-Type': 'text/plain'});   //very basic HTML coded response
    response.end('Hello World...\n\n\n ... and goodbye!\n');  //and the message within.
    } ).listen (listenPort);                                  //finish the createServer call by asking
                                                              //it to lisen at the listenPort

console.log('Server Started... open a web-browser and goto localhost:' + listenPort + ' to see if it works');
